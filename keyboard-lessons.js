...
window.keyboardLessons = [
    ...
    {
        id: 8, lesson: "8-р шат",
        keys: ["е","щ","ф","ц","у","ж","э","н","г","ш","ү","з","к","ъ","й","ы","б","ő","а","х","р","о","л","д","п","я","ч","ё","с","м","и","т","ь","в","ю"]
    }
];
...
window.kbFingerMap = {
    ...
    "2-3":  { hand: "left",  finger: 1, name: "Зүүн гарын долоовор" },   // ő
    ...
    "2-9":  { hand: "right", finger: 3, name: "Баруун гарын ядам" },     // д
